...
**v5 is proposed, not started**: ADR-0067 (Proposed) forks a governable, fully
autonomous agent onto a long-lived branch under a new name, with amended rules
on that line only; `docs/v5/use-cases.md` has the workloads. No v5 code until
the ADR is accepted and a tier ADR, PRD and plan exist.
